...
# modified Victoria Slonosky, Frederic Fabry, John Lindsay
...
item = "12"
ledger = "B"
imagefolder = 'Item12_Reel2_1880_Jan-Jul/'
cropdimensions = (2000,  100,  5000,  500) ##values are x.y for top left and x.y for bottom right of crop area (in that order)
start = datetime.date(1880, 1, 1)
